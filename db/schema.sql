...
(
  ...
  desired_a4 char(1) DEFAULT NULL,
  desired_a5 char(1) DEFAULT NULL,
  desired_a6 char(1) DEFAULT NULL,
  desired_a7 char(1) DEFAULT NULL,
  desired_a8 char(1) DEFAULT NULL,
  desired_a9 char(1) DEFAULT NULL,
  desired_a10 char(1) DEFAULT NULL,
  desired_a11 char(1) DEFAULT NULL,
  PRIMARY KEY(id)
);
